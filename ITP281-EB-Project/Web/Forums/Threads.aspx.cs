...
public partial class Web_Forums_Threads : System.Web.UI.Page
{
    ...
    protected void bind()
    {
        ...
        ForumList = Forum.getForumClass(FID);
        Title.Text = ForumList[0].Forum_Title.ToString();
        Desc.Text = ForumList[0].Forum_Desc.ToString();
    ...
    protected void gv_ThreadData_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/Web/Forums/Thread.aspx?Thread_ID=" + Thread_ID);
    }

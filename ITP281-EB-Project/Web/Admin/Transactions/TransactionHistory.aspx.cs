...
public partial class Web_Admin_Transactions_TransactionHistory : System.Web.UI.Page
{
    ...
    protected void gv_Transaction_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        string transactionID = ((TextBox)row.Cells[1].Controls[0]).Text;  //Retrieving data from the textbox and store into variable
    ...
    protected void bind()
    {
        ...
        var transactionList = TransactionHistoryClass.getTransactions();

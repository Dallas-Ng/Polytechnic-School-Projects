...
public partial class Web_Admin_Courses_CoursesView : System.Web.UI.Page
{
    ...
    protected void gvFeedback_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        Response.Redirect("~/Web/Admin/Courses/CoursesView.aspx");
    }
    ...
    {
        Response.Redirect("~/Web/Admin/Courses/Topics/Topics.aspx");
    }
    ...
    {
        string Course_ID = Request.QueryString["Course_ID"];
        Response.Redirect("~/Web/Admin/Courses/Topics/TopicsInsert.aspx?Course_ID=" + Course_ID);
    }

    protected void btn_return_Click(object sender, EventArgs e)
    {
        string Course_ID = Request.QueryString["Course_ID"];
        Response.Redirect("~/Web/Admin/Courses/Courses.aspx?Course_ID=" + Course_ID);
    }
    ...
    protected void gvTopic_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/Web/Admin/Courses/Topics/TopicsView.aspx?Topic_ID=" + TopicID +"&Course_ID=" + Course_ID);
    }
    ...
    protected void gvTopic_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        //string tDate = ((TextBox)row.Cells[2].Controls[0]).Text;
        //string tProgress = ((TextBox)row.Cells[3].Controls[0]).Text;
        //result = topic.TopicUpdate(tid, tTitle, tDate, int.Parse(tProgress));
        //if (result > 0)
        //{
    ...
    {
        Response.Redirect("~/Web/Admin/CoursesTopics/Slides/Slides.aspx");
    }

    protected void btn_View_Videos_Click(object sender, EventArgs e)
    {
        Response.Redirect("~/Web/Admin/Courses/Topics/Video/Video.aspx");
    }

...
public partial class Web_Admin_Course_Courses : System.Web.UI.Page
{
    ...
    protected void bind()
    {
        ...
        CourseList = aCourse.getCourseAll();
    ...
    protected void gvCourse_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/Web/Admin/Courses/CoursesView.aspx?Course_ID=" + CourseID);
    }
    ...
    {
        Response.Redirect("~/Web/Admin/Courses/CoursesInsert.aspx");
    }
    ...
    protected void btn_Search_Click(object sender, EventArgs e)
    {
        ...
        dt = CourseClassOj.Search(tb_Search.Text);

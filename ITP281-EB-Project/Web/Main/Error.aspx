<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Error.aspx.cs" Inherits="Web_Error" %>
...
<body>
    <div class="container">
        <div class="error">
            ...
            <p>
                An error has occured. A email will be sent to the administrator.
            </p>
            <form runat="server" id="form1">
            <asp:Button runat="server" ID="btn_Back" CssClass="btn btn-info" Text="Go back to Home" OnClick="btn_Back_Click"/>
                </form>
        </div>

<%@ Page Title="" Language="C#" MasterPageFile="~/Static/Master/Teacher/Settings.master" AutoEventWireup="true" CodeFile="Change_Password.aspx.cs" Inherits="Web_Teacher_Settings_Change_Password" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Content5" runat="Server">
    <style>
        #BodyPlaceHolder_lbtn_Password {
            color: black;

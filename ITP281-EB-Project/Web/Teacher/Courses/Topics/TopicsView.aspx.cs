...
public partial class Web_Teacher_Courses_Topics_TopicsView : System.Web.UI.Page
{
    ...
    {
        //Response.Redirect("~/Web/Teacher/Course/Topics/Quiz/QuizView.aspx?Topic_ID=" + TopicID);
    }
    ...
    protected void btn_Create_Quiz_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/Web/Teacher/Courses/Topics/Quiz/QuizInsert.aspx?Topic_ID=" + Request.QueryString["Topic_ID"].ToString() + "&Course_ID=" + Request.QueryString["Course_ID"].ToString());
    }
    ...
    protected void gvSlides_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        string Topic_ID = Request.QueryString["Topic_ID"];
        Response.Redirect("~/Web/Teacher/Courses/Topics/Slides/SlidesDetails.aspx?Slides_ID=" + Slides_ID + "&Topic_ID=" + Topic_ID + "&Course_ID=" + Request.QueryString["Course_ID"].ToString());
    }
    ...
    protected void gvQuiz_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/Web/Teacher/Courses/Topics/Quiz/QuizInsert.aspx?Quiz_ID=" + Quiz_ID + "&Topic_ID=" + Topic_ID + "&Course_ID=" + Request.QueryString["Course_ID"].ToString());

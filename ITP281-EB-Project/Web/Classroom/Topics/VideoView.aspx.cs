...
public partial class Web_Classroom_Topics_VideoView : System.Web.UI.Page
{
    ...
    protected void bind()
    {
        ...
        Video2.Attributes["src"] = Source + VideoList[0].Video_ID.ToString() + "_" + VideoList[0].Video.ToString();
    ...
    protected void btn_Return_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/Web/Classroom/Topics/TopicsView.aspx?Topic_ID=" + Topic_ID);
    }
}
